<?php
	...
	$EMailNote .= "<p>Replied your message to be as follows：</p>\n";
	...
	$EMailNote .= "<p>\n";
	$EMailNote .= "Please feel free to contact US if you have any questions<br />\n";
	$EMailNote .= "Service : {CompanyEMail}<br />\n";
