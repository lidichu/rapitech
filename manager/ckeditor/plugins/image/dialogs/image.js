								...
								children: [{
									...
									commit: function(C, D, E) {
										...
										if (C == d) {
											...
											else D.removeStyle('width'); ! E && D.removeAttribute('width');
										} else if (C == f) {
											var G = F.match(h);
											if (!G) {
								...
								},
								{
									...
									commit: function(C, D, E) {
										...
										if (C == d) {
											...
											else D.removeStyle('height'); ! E && D.removeAttribute('height');
										} else if (C == f) {
											var G = F.match(h);
											if (!G) {
												var H = this.getDialog().originalElement;
