...
function(n) {
    ...
    function u(a) {
        for (var g, c = a.length,
        d = [], e = 0; e < c; e++) g = a.charCodeAt(e),
        d.push(g);
    ...
    I = function(a, g) {
        ...
        function(a, c, d) {
            if (c == q) {
                ...
                for (var a = b.email = {},
                c = /(^')|('$)/g,
                d = d.match(/[^,\s]+/g), e = d.length, g, f, h = 0; h < e; h++) g = decodeURIComponent,
    ...
    return {
        ...
        onShow: function() {
            ...
            b = a.getSelection(),
            c = null; (c = w.getSelectedLink(a)) && c.hasAttribute("href") ? b.getSelectedElement() || b.selectElement(c) : c = null;
