<?php
	class PICFieldsH5T implements ManagerItem{
		var $FieldTitle;
		var $FieldName;
		var $ShowName;
		var $NullFlag;
		...
		var $ShowHeight;
		var $ShowRoot;
		public function PICFieldsH5T($FieldTitleIn,$FieldNameIn,$ShowNameIn,$NullFlagIn=false,$FilePathArrayIn,$WidthArrayIn=null,$HeightArrayIn=null,$NoteIn,$TitleFieldIn="",$TitleShowIn="",$NumIn=1,$OtherVarIn="",$FieldNameHiddenIn="",$BoxModeIn,$ShowWidthIn,$ShowHeightIn,$ShowRootIn){
