<?php
	class PICFieldsH5 implements ManagerItem{
		var $FieldName;
		var $ShowName;
		var $NullFlag;
		var $FilePathArray;
		...
		var $ShowHeight;
		var $ShowRoot;
		public function PICFieldsH5($FieldNameIn,$ShowNameIn,$NullFlagIn=false,$FilePathArrayIn,$WidthArrayIn=null,$HeightArrayIn=null,$NoteIn,$TitleFieldIn="",$TitleShowIn="",$NumIn=1,$OtherVarIn="",$FieldNameHiddenIn="",$BoxModeIn,$ShowWidthIn,$ShowHeightIn,$ShowRootIn){
