...
$M->AddPIC3 ( 'PIC', '圖片', true, $FilePathArray, $WidthArray, $HeightArray, '圖片限寬高 ' . $WidthArray [0] . "x" . $HeightArray [0] . "像素", '', '', '', 'PICHidden', $BoxModeArray, 334, "", $UploadPic ["PIC"] ["Path"] );
...
if ($Option == "Add") {
	...
	if ($YesNo == "true") {
		...
		$AddFieldsSQL .= ",IndexShow,IndexSort";
		$AddValuesSQL .= ",'flase',9999";
...
<body>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td align="center">
				<form action="<?php echo $Action?>" method="POST" id="form1"
			...
			<table width="600" border="1" cellspacing="0"
						...
						<tr>
							<td>
								<table border="0" bgcolor="#A3BFE2" cellspacing="1"
									cellpadding="5" width="100%" style="font-size: 10pt">
						<?php $M->{$MFun}()?>
						</table>
							</td>
						</tr>
					</table>
					<input type="button" value="確定" id="cmdEnter" name="cmdEnter"
						onclick="<?php echo $ButFun?>">&nbsp;&nbsp;&nbsp;&nbsp; <input
						type="button" value="取消" id="cmdCancel" name="cmdCancel"
						onClick="cmdCancel_onclick();">
