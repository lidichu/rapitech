...
<?php
	...
	$M = new Manager();
	$M->AddNote2("Keywords",$DBFieldName["Keywords"],false);
	$M->AddNote2("Description",$DBFieldName["Description"],false);
	$AddFieldsSQL = "";
	$AddValuesSQL = "";
	$ModifySQL = "";
	//接收操作參數
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
    ...
    <tr>
    	<td align="center">
            <form action="<?php echo GetSCRIPTNAME(); ?>" method="post" name="form1" id="form1" style="margin:0px;padding:0px;">
                ...
                <table width="520" border="1" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
                    <tr>
                        <td>	
                            <table id="keyTable" name="keyTable" border=0 bgcolor="#A3BFE2" cellspacing="1" cellpadding="5" width="100%" style="font-size:10pt">
								<?php $M->ModifyShow();?>
							</table>	
                        </td>
                    </tr>		
