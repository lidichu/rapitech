...
<?php
	...
	$M->AddFile("File","檔案",true,$UploadFilePath,"","","G1=".$_REQUEST["G1"]);
...
function Add(){
	...
	global $UploadPicBigFilePath,$UploadPicSmallFilePath;
	global $PicSmallWidth,$PicSmallHeight;
	...
	if($YesNo=="true"){
		...
		if($M->haveG){
			...
			$SQL = "Insert Into ".$DBTable."(".$AddFieldsSQL.",G".($Level-1).") values(".$AddValuesSQL.",".$G[$Level-1].")";	
		}
