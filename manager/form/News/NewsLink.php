...
<?php
	...
	//參數設定
		...
		$Title=$Title01;
		$MainFileName="News.php";
		//要查詢的欄位
		$SQLFields="SerialNo,Title,Url,TargetWindow,Sort,Status";
		//預設排序方式
		$DefaultSort = "Sort,SerialNo Desc";
		//指定那個欄位為修改聯結欄
		$UpdateField = "Title";					//欄位名稱
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
		<td align="center">
        	<?php
				$SQL="Select Title From ".$DatabaseName01." Where SerialNo=".$G[0];
				$Rs = mysql_query($SQL,$Conn);
				if($Rs && (mysql_num_rows($Rs)>0)){
					$Row=mysql_fetch_array($Rs);
                ...
                <tr>
                    <td bgcolor="#A3BFE2">
                        ...
                        <tr style="font-size:13;color:#E0EFF8" bgcolor="#005783" align="center">
							...
							<td nowrap><a class="Title sortlink" href="<?php echo GetSCRIPTNAME(); ?>?SF<?php echo $Level; ?>=Title"><font color="#FFFFFF">標題</font></a></td>
							<td nowrap width="350"><a class="Title sortlink" href="<?php echo GetSCRIPTNAME(); ?>?SF<?php echo $Level; ?>=Url"><font color="#FFFFFF">網址</font></a></td>
							<td nowrap width="100"><input type="button" name="TargetWindowUpdate" value="更新開啟方式" onClick="cmdTargetWindowUpdate_onclick('<?php echo GetSCRIPTNAME(); ?>');"></td>
                        ...
                        <?php
                                ...
                                $Rs = mysql_query($SQL,$Conn);
                                ShowOnePageMe($Rs,$page,$NoShowFields,$File_Add_Modify,$UpdateField,$UpdateFieldAlign,"FileHidden",180,$UploadFilePath,$DBTableName,"G".$Level);
                        ?>
                        </table>
                    </td>
                </tr>
