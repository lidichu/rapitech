...
<?php
	...
	//參數設定
		...
		$Level = 1;
		//標題文字
		$TableTitle = $Title02_2;
		
		$Title=$Title01;
		$MainFileName="News.php";
		//要查詢的欄位
		$SQLFields="SerialNo,Title,File,Sort,Status";
		//預設排序方式
		...
		//修改資料網頁名稱
		$ModifyFileName = $ModifyFileName02_2;
		//按鈕式超連結,其變數值為要聯結的網頁名稱
		$DBTableName[0]= $MainFileName03;
		//修改資料庫名稱
		$DBTable = $DatabaseName02_2;
		//顯示資料庫名稱
		$DBTable_S = $DatabaseName02_2_S;
		//可查詢欄位
		$QueryField["Title"] = "標題";
		$QueryField["File"] = "檔案名稱";
		...
		function DelItem(){
			...
			for($i=1;$i<=$RowCount;$i++){
				...
				if($tmpCheckBox!=""){
					//刪除檔案
					$SQL="Select FileHidden From ".$DBTable." Where SerialNo=".$_REQUEST["SERIALNO".$i];
                ...
                <tr>
                    <td bgcolor="#A3BFE2">
                        ...
                        <tr style="font-size:13;color:#E0EFF8" bgcolor="#005783" align="center">
							...
							<td nowrap><a class="Title sortlink" href="<?php echo GetSCRIPTNAME(); ?>?SF<?php echo $Level; ?>=File"><font color="#FFFFFF">檔案名稱</font></a></td>
