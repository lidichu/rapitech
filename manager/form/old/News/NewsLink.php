...
<?php
	...
	//參數設定
		...
		//要查詢的欄位
		$SQLFields="SerialNo,Title,LinkUrl,TargetWindow,Sort,Status";
		//預設排序方式
                ...
                <tr>
                    <td bgcolor="#A3BFE2">
                        <table cellspacing="1" cellpadding="2" width="100%" border="0">
							...
							<td nowrap ><font color="#FFFFFF" style="font-size:13px;">標題</font></td>
