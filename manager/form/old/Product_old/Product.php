...
<?php
	...
	//參數設定
		...
		$TableTitle = $Title02;
		//要查詢的欄位
		$SQLFields="SerialNo,IsRecommend,IsNew,ProductName,ProductPrice,PICHidden,Sort,Status";
		//預設排序方式
                    ...
                    <td bgcolor="#A3BFE2">
                        <table cellspacing="1" cellpadding="2" width="100%" border="0">
	                        <tr style="font-size:13;color:#E0EFF8" bgcolor="#005783" align="center">
								...
								<td nowrap width="60" style="font-size:12px;"><font color="#FFFFFF">商品價格</font></td>
