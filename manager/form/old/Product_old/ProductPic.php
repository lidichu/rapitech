...
<?php
	...
	//參數設定
		...
		$TableTitle = $Title03;
		//要查詢的欄位
		$SQLFields="SerialNo,PICHidden,Sort";
		//預設排序方式
            ...
            <table width="100%" border="1" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
                <tr>
                    ...
                    <td width="15%" align="right" bgcolor="#EEEEEE">
						...
						?>
					    <input type="button" value="新 增" id="cmdAdd" name="cmdAdd" onClick="<?php if(count($Temp_PIC)>3){ ?> alert('最多四張圖片，請先刪除！'); <?php }else{ ?> cmdAdd_onclick('<?php echo $ModifyFileName01; ?>'); <?php } ?>" >&nbsp;&nbsp;
