...
<?php
	...
	//參數設定
		...
		//修改資料網頁名稱
		$ModifyFileName = $ModifyFileName09;		
		//按鈕式超連結,其變數值為要聯結的網頁名稱
		$DBTableName[0]= "";
		//修改資料庫名稱
		$DBTable = $DatabaseName09;
		//顯示資料庫名稱
		$DBTable_S = $DatabaseName09_S;
		//可查詢欄位
		...
		//PageCount處理
		$PageCount = 0;
		$Query.=" and OD.IsNew = '是' and OA.Status ='已處理' and OL.SerialNo = OA.G0 and OD.G0 = OA.G0";
