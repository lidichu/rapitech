...
<?php
	...
	if($Option=="Add"){
		...
		$A="'".$G[0]."','".$Temp_Order_List["MemberID"]."','".Date('Y-m-d H:i:s')."','已付款','已出貨','是'";
...
function cmdSubmit_onclick(){
	var msg="是否確定出貨？";
	if(confirm(msg)){
		$("#form1").attr("action","<?php echo GetSCRIPTNAME(); ?>?option=OrderShip&G0=<?php  echo $G[0] ?>");
		$("#form1").submit();
	}
}
</script>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		<td align="center">
			...
			<input type="button" value="出貨" id="cmdSend" name="cmdSend" onClick="cmdSubmit_onclick();">
