...
<?php
	...
	//參數設定
		...
		//修改資料網頁名稱
		$ModifyFileName = $ModifyFileName07;		
		//按鈕式超連結,其變數值為要聯結的網頁名稱
		$DBTableName[0]= "";
		//修改資料庫名稱
		$DBTable = $DatabaseName07;
		//顯示資料庫名稱
		$DBTable_S = $DatabaseName07_S;
		//可查詢欄位
		...
		//PageCount處理
		$PageCount = 0;
		$Query.=" and OD.IsNew='是' and OD.ManagerHandle ='交易完成' and OD.PayHandle ='退貨申請' and OL.SerialNo = OD.G0";
