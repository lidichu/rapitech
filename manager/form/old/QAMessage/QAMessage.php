...
<?php
	...
	//參數設定
		...
		$TableTitle = $Title01;
		//要查詢的欄位
		$SQLFields="SerialNo,date_format(`PostDate`,'%Y-%m-%d %H:%i') As PostDate,(Select MemberID From member Where SerialNo = MemberSN),`MemberName`,(Select ProductID From product Where SerialNo = ProductSN),`ProductName`,`Content`,`Status` As ContactStatus,'QAMessageReply.php' as replyemail";
		//預設排序方式
		...
		//可查詢欄位
		$QueryField["ProductName"] = "商品名稱";
		$QueryField["MemberName"] = "會員名稱";
		$QueryField["PostDate"] = "日期";
		//可查詢列表
		$QueryList=Array();
		//資料庫額外欄外
		$QueryFiled=Array();
		...
		$Tree_AmountQAM = intval($Tree_Row2["Num"]);
?>
...
var TAQAM = "<?php echo ($Tree_AmountQAM); ?>";
$(function(){
	if (window.parent.frames["menu"] != undefined){
		$(window.parent.frames["menu"].document).find("#Menu_QAManager").html("("+(parseInt(TAQAM))+")");
		$(window.parent.frames["menu"].document).find("#Tree_QAM").html("("+(parseInt(TAQAM))+")");
	}
});
</script>
                    ...
                    <td bgcolor="#A3BFE2">
                        <table cellspacing="1" cellpadding="2" width="100%" border="0">
	                        <tr style="font-size:13;color:#E0EFF8" bgcolor="#005783" align="center">
		                        ...
		                        <td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">時間</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">會員編號</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">會員姓名</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">商品編號</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">商品名稱</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">問題</font></td>
