<?php ob_start(); ?>
<?php
	include_once("OrderQAParame.php");
	...
	//參數設定
		...
		$TableTitle = $Title01;
		//要查詢的欄位
		$SQLFields="SerialNo,OrderNumber,date_format(`OrderDate`,'%Y-%m-%d') As OrderDate,MemberID,MemberName,date_format(`PostDate`,'%Y-%m-%d %H:%i:%s') As PostDate,`Content`,`Status` As ContactStatus,'OrderQAReply.php' as replyemail";
		//預設排序方式
		...
		$Tree_AmountQA = intval($Tree_Row2["Num"]);
?>
...
var TAQA = "<?php echo ($Tree_AmountQA); ?>";
$(function(){
	if (window.parent.frames["menu"] != undefined){
		$(window.parent.frames["menu"].document).find("#Menu_OrderQuestionManager").html("("+(parseInt(TAQA))+")");
		$(window.parent.frames["menu"].document).find("#Tree_OQA").html("("+(parseInt(TAQA))+")");
	}
});
</script>
                    ...
                    <td bgcolor="#A3BFE2">
                        <table cellspacing="1" cellpadding="2" width="100%" border="0">
	                        <tr style="font-size:13;color:#E0EFF8" bgcolor="#005783" align="center">
		                        ...
		                        <td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">訂單編號</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">訂單日期</font></td>
								...
								<td nowrap width="110" style="font-size:13px;"><font color="#FFFFFF">問題時間</font></td>
								<td nowrap width="100" style="font-size:13px;"><font color="#FFFFFF">問題內容</font></td>
