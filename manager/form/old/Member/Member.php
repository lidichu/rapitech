...
<?php
	...
	//參數設定
		...
		$TableTitle = $Title01;
		//要查詢的欄位
		$SQLFields="SerialNo,MemberID,MemberName,EMail,Tel,Mobile,(CASE (ActiveStatus) WHEN 'false' THEN '' WHEN 'true' THEN 'OK' END) as ActiveStatus,(CASE (IsVIP) WHEN 'false' THEN '否' WHEN 'true' THEN '是' END) as IsVIP ,VIPID";
		//預設排序方式
		...
		$DBTableName[0]= $MainFileNameLogin;
		//修改資料庫名稱
...
function cmdExcel_onclick(){
	window.location.href=file_add_modify+"?option=ExcelIn"+otherstring;
}
</script>
            ...
            <table width="100%" border="1" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
                <tr>
                    ...
                    <td width="5%" align="right" bgcolor="#EEEEEE">
                    	<?php if(strtolower($id) == "admin"){ ?>
						<input type="button" value="匯 入" id="cmdExcel" name="cmdExcel" onClick="cmdExcel_onclick('<?php echo GetSCRIPTNAME(); ?>');" / />
						<?php } ?>
                    ...
                    <td bgcolor="#A3BFE2">
                        <table cellspacing="1" cellpadding="2" width="100%" border="0">
	                        <tr style="font-size:13;color:#E0EFF8" bgcolor="#005783" align="center">
								...
								<td nowrap width="80" style="font-size:13px;"><font color="#FFFFFF">市話</font></td>
								<td nowrap width="80" style="font-size:13px;"><font color="#FFFFFF">手機</font></td>
								<td nowrap width="80" style="font-size:13px;"><font color="#FFFFFF">啟用(可登入)</font></td>
								...
								<td nowrap width="80" style="font-size:13px;"><font color="#FFFFFF">來店購買</font></td>
							</tr>
                        <?php
