<?php ob_start(); ?>
<?php
	include_once("NewSortParame.php");
            ...
            <table width="100%" border="1" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
                <tr>
                    ...
                    <td width="5%" align="center" bgcolor="#EEEEEE">
                        <input type="button" value="取消新品" id="cmdDel" name="cmdDel" onClick="cmdDel_onclick('<?php echo GetSCRIPTNAME(); ?>');" >
                    </td>
                </tr>
            </table>
            </form>
