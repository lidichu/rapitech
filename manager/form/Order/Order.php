...
<?php
	...
	//參數設定
		...
		//PageCount處理
		$PageCount = 0;
		$SQL = "Select Count(SerialNo) As Num From ".$DBTable_S.",ordermain,ordermember ".$Query;
...
$(function(){
	...
	$(window.parent.frames["menu"].document).find("#order").html("("+Count+")");
	$(window.parent.frames["menu"].document).find("#order2").html("("+Count+")");
	    ...
	    <td align="center">
            ...
            <table width="100%" border="1" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
                <tr>
                    ...
                    <td width="10%" align="right" bgcolor="#EEEEEE">
