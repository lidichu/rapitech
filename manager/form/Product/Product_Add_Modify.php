...
function Add(){
	...
	if($YesNo=="true"){
		$M->AddHandle();
		if($M->haveG){
			$SQL = "Insert Into ".$DBTable."(".$AddFieldsSQL.",`IndexShow`,`IndexSort`) values(".$AddValuesSQL.",'false',9999)";		
		}else{
			$SQL = "Insert Into ".$DBTable."(".$AddFieldsSQL.",G".($Level-1).",`IndexShow`,`IndexSort`) values(".$AddValuesSQL.",".$G[$Level-1].",'false',9999)";	
		}
