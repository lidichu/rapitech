...
include_once("../../inc/LevelOne.php"); 	//更新狀態與排序
	...
	//參數設定
		...
		if(strtolower($id)!="admin"){
			if($Query!=""){
				$Query = $Query." and Acc <> 'Admin' ";
			}else{
				$Query = " where Acc <> 'Admin' ";
			}
		}
...
<table width="100%" border="1" cellspacing="0" bordercolorlight="#666666" bordercolordark="#FFFFFF">
	<tr>
		<td width="88%" align="left" bgcolor="#EEEEEE">
            &nbsp;&nbsp;
	...
	<tr>
		<td bgcolor="#A3BFE2">
			...
			<tr style="font-size:13pt;color:#E0EFF8" bgcolor="#005783" align="center">
				<td nowrap><a class="Title sortlink" href="<?php echo GetSCRIPTNAME(); ?>?SF<?php echo $Level; ?>=Acc"><font color="#FFFFFF">帳號</font></a></td>
				<td nowrap><a class="Title sortlink" href="<?php echo GetSCRIPTNAME(); ?>?SF<?php echo $Level; ?>=Name"><font color="#FFFFFF">姓名</font></a></td>
				<td nowrap><a class="Title sortlink" href="<?php echo GetSCRIPTNAME(); ?>?SF<?php echo $Level; ?>=Email"><font color="#FFFFFF">EMail</font></a></td>
			</tr>	
			<?php
