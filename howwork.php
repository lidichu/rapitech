...
<body>
    ...
    <div id="carousel-id" class="contair-fluid">
        <div class="row">
            <div class="col-sm-12  col-md-12 col-lg-12">
                <img src="images/about/work.png" class="img-responsive ">
                <br>
            </div>
        </div>
    </div>
    ...
    <div class="container ">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail ">
                <img src="images/howwork/step1.png">
            </a>
        </div>

        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail">
                <img src="images/howwork/step2.png">
            </a>
        </div>

        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail ">
                <img src="images/howwork/step3.png">
            </a>
        </div>

        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail">
                <img src="images/howwork/step4.png">
            </a>
        </div>
        <!-- 一組4個 -->
        <!-- 一組4個 -->
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail ">
                <img src="images/howwork/step8.png">
            </a>
        </div>

        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail">
                <img src="images/howwork/step9.png">
            </a>
        </div>

        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail ">
                <img src="images/howwork/step10.png">
            </a>
        </div>

        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3 wow flipInY">
            <a class="thumbnail">
                <img src="images/howwork/done.png">
            </a>
