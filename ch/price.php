		...
		<div id="frame">
			...
			<div id="memu_left">
				...
				<div>
					...
					<ul class="menu">
						...
						<li><a href="price.php"><img src="../images/index/but3_1.png"
			...
			<div id="banner_right">
				...
				<div>
					...
					<div id="room_left">
						<!--房間介紹menu-->
						<img src="images/price/title.png" width="133" height="120">
						<div align="center">
							<img src="images/rooms/menu.png" width="195" height="27">
						</div>
						<ul class="room_menu">
							<li onClick="window.location='javascirpt:;'" class="current">價格表</li>
						</ul>
					</div>
					<!--房間介紹menu End-->
					<div id="room_right">
						<!--map-->
						<table width="704" border="0" cellspacing="0" cellpadding="3"
							class="datetable style9">
							<tr>
								<td height="35" colspan="2" align="center" bgcolor="#4B1D2C"
									class="style8">房間價格表</td>
							</tr>
							<tr>
								<td width="104" height="35" align="center" bgcolor="#F1EDED">單日租</td>
								<td width="596" class="style6">每晚 800 元起</td>
							</tr>
							<tr>
								<td height="35" align="center" bgcolor="#F1EDED">週 租</td>
								<td class="style6">只租一星期 3,500 元起</td>
							</tr>
							<tr>
								<td height="35" align="center" bgcolor="#F1EDED">雙週租</td>
								<td class="style6">只租二星期 5,000 元起</td>
							</tr>
							<tr>
								<td height="35" align="center" bgcolor="#F1EDED">單月租</td>
								<td class="style6">只租一個月月租 7,000 元起</td>
							</tr>
							<tr>
								<td height="35" align="center" bgcolor="#F1EDED">季 租</td>
								<td class="style6">每個月 6,000 元起</td>
							</tr>
							<tr>
								<td height="35" align="center" bgcolor="#F1EDED">半年租</td>
								<td class="style6">每個月 5,500 元起</td>
							</tr>
							<tr>
								<td height="35" align="center" bgcolor="#F1EDED">年 租</td>
								<td class="style6">每月 5,300 元起</td>
							</tr>
							<tr>
								<td height="35" colspan="2" align="center" bgcolor="#F1EDED">註：房價依房間大小及景氣好壞作調整。公司出差可開立發票，備有汽機車停車場，尚有辦公室出租。</td>
							</tr>
						</table>
					</div>
					<!--map End-->
