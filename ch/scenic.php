		...
		<div id="frame">
			...
			<div id="memu_left">
				...
				<div>
					...
					<ul class="menu">
						...
						<li><a href="scenic.php"><img src="../images/index/but5_1.png"
								name="Image8" width="16" height="212" id="Image8"></a></li>
			...
			<div id="banner_right">
				...
				<div>
					...
					<div id="room_left">
						<!--房間介紹menu-->
						<img src="images/scenic/title.png" width="133" height="120">
						<div align="center">
							<img src="images/rooms/menu.png" width="195" height="27">
						</div>
						<ul class="room_menu">
							<li onClick="window.location='javascirpt:;'" class="current">週邊景點</li>
						</ul>
					</div>
					<!--房間介紹menu End-->
					<div id="room_right">
						...
						<div class="pro_area">
							<!--1-->
							<div class="pro_sp">
								<span></span><img src="images/scenic/pc.png" width="230"
									height="229">
							</div>
							<div align="center" class="style10 pro_title">
								<a href="http://www.chimeimuseum.org/" target="_blank"
									class="style10">奇美博物館| Chimei Museum</a>
							</div>
						</div>
						<!--1 End-->
						<div class="pro_area">
						...
						<!--3 End-->
						<br class="clear-both">
						<div style="width: 655px; height: 40px; margin: 0 auto;">
							<!--page-->
							<table border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td>
										<ul class="page">
											<li onClick="window.location.href='scenic.php'"
												class="style11"
												style="border: 0; width: 60px; color: #8A3451">上一頁</li>
											<li onClick="window.location.href='scenic.php'">1</li>
											<li class="current"
												onClick="window.location.href='scenic.php'">2</li>
											<li onClick="window.location.href='scenic.php'">3</li>
											<li onClick="window.location.href='scenic.php'">4</li>
											<li onClick="window.location.href='scenic.php'">5</li>
											<li onClick="window.location.href='scenic.php'">6</li>
											<li onClick="window.location.href='scenic.php'">7</li>
											<li onClick="window.location.href='scenic.php'">8</li>
											<li onClick="window.location.href='scenic.php'">9</li>
											<li onClick="window.location.href='scenic.php'">10</li>
											<li onClick="window.location.href='scenic.php'"
												class="style11"
												style="border: 0; width: 60px; color: #8A3451">下一頁</li>
										</ul>
									</td>
								</tr>
							</table>
