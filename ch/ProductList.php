...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Rapitech Product List</title>
                        ...
                        <div class="module left">
                            <ul class="menu">
                                <li>
                                     ...
                                     <a href="#"><span class="label label-success">About Us</span></a>
                            ...
                            <div class="function">
                                <div class="widget">
                                    ...
                                    <div class="cart-controls">
                                        <a class="btn btn-sm btn-filled" href="cart.php">Product List</a>
...
<!--end nav  -->
        ...
        <div class="main-container">
                ...
                <h4 class="text-center wordColor wow bounceIn" data-wow-delay="3s">Measuring11</h4>
                <hr>
                            ...
                            <div class="image-tile outer-title text-center">
                                ...
                                <div class="title">
                                    <h5 class="mb0">Adrian
                                         LambsWool Cap</h5>
                                    <br>
                                            <a class="btn btn-sm btn-rounded" href="Product.php">detail</a>
                                </div>
                            </div>
                        </div>
                        <!--end three col-->
                            ...
                            <div class="image-tile outer-title text-center">
                                ...
                                <div class="title">
                                    <h5 class="mb0">Stanley
                                     Leather Wallet</h5>
                                    <br>
                                            <a class="btn btn-sm btn-rounded" href="#">detail</a>
                                </div>
                            </div>
                        </div>
                        <!--end three col-->
