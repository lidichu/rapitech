...
<body>
		...
		<br>
		<h1 class="text-center wordColor wow bounceIn" data-wow-delay="3s">Contact
			us</h1>
		<hr>
		<section class="p0">
			<div class="map-holder pt160 pb160 wow fadeIn">
				<iframe
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3683.3136650838424!2d120.29796401538883!3d22.60475923748517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x346e037776556f41%3A0xc45467858397992e!2sNo.+12%2C+Fuxing+4th+Rd%2C+Qianzhen+District%2C+Kaohsiung+City%2C+806!5e0!3m2!1sen!2stw!4v1461552570851"
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-5 col-md-5">
						...
						<p>Your questions and comments are important to us. Leave your
							message in the form, or reach us by phone or email. We will
					...
					<div class="col-sm-7 col-md-6 col-md-offset-1">
						<form class="form-inline" id="form1" action="contact_handle.php"
							method="post" name="form1"
							data-success="Thanks for your submission, we will be in touch shortly."
							data-error="Please fill all fields correctly.">

							<div class="form-group">
								<label for="name"><label display="initial" style="color: red">*</label>NAME：</label> <input id="name" type="text"
									class="validate-required" name="name" placeholder="" />
							</div>
							...
							<div class="form-group">
								...
								<input id="tel" type="text" class="validate-required" name="Tel"	placeholder="" /> 
							</div>
							<div class="form-group">
								<label for="email"><label display="initial" style="color: red">*</label>EMAIL：</label>
								<input id="email" type="text" class="validate-required validate-email" name="EMail" placeholder="" />
							</div>							
							
							<!-- contry -->
							<div class="form-group  ">
								<label for="country"><label display="initial" style="color: red">*</label>Country：</label>
								<select id="country" name="AddressCity"
									class="cbg" id="sel1">
							...
							<div class="form-group">
								<label for="subject"><label display="initial" style="color: red">*</label>Subject：</label>
								<input id="subject" type="text" class="validate-required"
									name="Subject" placeholder="" />
							</div>
							<div class="form-group">
								<label for="message"><label display="initial" style="color: red">*</label>Message：</label>
								<textarea id="message" class="validate-required" name="Note" rows="3"
							...
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									...
									<td width="60"><a id="imgVCode" href="#" class="number"
										onfocus="blur()"><img src="../Scripts/SafeCode.php" border="0" /></a></td>
									<td><input name="VCode" class="key" type="text" id="VCode"
										size="30" style="width: 120px" maxlength="4" /></td>
								</tr>
							</table>
