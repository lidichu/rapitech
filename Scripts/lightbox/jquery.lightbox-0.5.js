	...
	$.fn.lightBox = function(settings) {
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				objWidth = objImagePreloader.width;
				objHeight = objImagePreloader.height;
				if(parseInt(objWidth)>800){
					objHeight = parseInt(800 * objHeight / objWidth);
					objWidth = 800;
				}
				$('#lightbox-image').attr({'src':settings.imageArray[settings.activeImage][0],width:objWidth,height:objHeight});
