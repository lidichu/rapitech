    ...
    <div id="carousel-id" class="contair-fluid">
        <div class="row">
            <div class="col-sm-12  col-md-12 col-lg-12">
                <img src="images/web/web.png" class="img-responsive">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <img class="featurette-image img-circle img-responsive pull-left wow flipInX " src="images/web/web1.png">
                    <!-- <img src="img/p1.png"> -->
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-md-push-8 col-xs-12">
                    <!--  <img src="img/p2.png"> -->
                    <img class="featurette-image img-circle img-responsive pull-left wow flipInX" src="images/web/web2.png">
                </div>
...
客戶自然就會對您的網站留下更好的印象。
            ...
            <div class="row">
                    ...
                    <br>
                    <img class="featurette-image img-circle img-responsive pull-left wow flipInX" src="images/web/web4.png">
                    <!-- <img src="img/p1.png"> -->
                </div>
                <div class="col-md-8 col-sm-8 col-xs-12">
